...
export function ProductFilters() {
  ...
  const categories = [
    ...
    { id: "faith-decor", name: "Faith-Based Decor", image: "/optimized-products/medium/Adonai (12 × 12in) - No Broader_medium.webp" },
    { id: "wedding-decor", name: "Wedding Decor", image: "/optimized-products/medium/A wife of noble character (4.5 ratio)_medium.webp" },
    { id: "love-decor", name: "Love Decor", image: "/optimized-products/medium/Jesus & Me  (12 × 12in)_medium.webp" },
    { id: "home-decor", name: "Home Décor", image: "/optimized-products/medium/Hope -Black Background (24 × 32in)_medium.webp" },
    { id: "digital-prints", name: "Digital Prints", image: "/optimized-products/medium/I AM saved  (11 × 14in)_medium.webp" },
    { id: "christian-faith", name: "Christian Faith", image: "/optimized-products/medium/Chosen- Black Boarder_medium.webp" },
    { id: "inspirational", name: "Inspirational", image: "/optimized-products/medium/Believe in You (16 × 20in)_medium.webp" },
  ]
